    ...
    <div className={classes.mainDiv}>
      <div className={classes.hero}>
        ...
        <p className={classes.context}>
          Our club seeks to increase student&#39;s problem-solving skills as
          well as their cp in order to improve their coding abilities. The
          following three steps describe how our Club operates.
        </p>
      </div>
