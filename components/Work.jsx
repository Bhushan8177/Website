    ...
    <div className="lg:ml-32 lg:mr-32">
      ...
      <div className="lg:flex lg:m-8 lg:flex-row ml-8 mr-8 lg:ml-16 lg:mr-16">
        <div className="shadow-md mb-4 flex flex-row lg:mr-16 lg:mb-0 p-4 rounded-2xl ">
          ...
          <div className="pt-4 pb-4 break-normal tracking-wide ">
            {" "}
            Our vision for the next two years is to create a community that will
            not only assist students in obtaining better placements and
            assisting them in their path, but will also give confidence in them
            to achieve future milestones.
          </div>
        </div>
      ...
      <div className="shadow-md ml-8 mr-8 flex  lg:ml-16 lg:mr-16 p-4 rounded-2xl  mb-16">
        ...
        <div className="pt-4 pb-4 tracking-wide ">
          {" "}
          Our vision for the next two years is to create a community that will
          not only assist students in obtaining better placements and assisting
          them in their path, but will also give confidence in them to achieve
      ...
      <div className="text-5xl font-bold font-Paytone text-[#469697] lg:pt-2 mt-32   text-center justify-center mb-8">
        Want to Join Club ??
        <div className="text-lg font-normal pt-8 pb-8 font-Paytone text-[#3A3A3A] tracking-wide  break-normal m-8 lg:ml-16 lg:mr-16 lg:mb-16">
          Fill the form Our vision for the next two years is to create a
          community that will not only assist students in obtaining better
          placements and assisting them in their path, but will also give
          confidence in them to achieve future milestones. We want to mentor and
          guide as many students as possible, as well as create a community that
          extends beyond our campus.
        </div>
