...
const Register = () => {
  return (
    <>
        ...
        <div className="lg:flex lg:fex-row mt-8 justify-center ml-8 mr-8 lg:ml-0 lg:mr-0">
          <div className="lg:flex lg:flex-col lg:mr-4 p-4 lg:pt-12 rounded-2xl bg-white lg:w-[447px] lg:h-[459px] mb-8">
            ...
            <div className="p-2 pt-4 lg:w-[412px] break-words">
              ...
              >
                https://docs.google.com/forms/d/e/1FAIpQLSetPmIxGa04RvRXWA22MhW9AlmYWGxhVG8eNbOLKXlWyHHpiQ/viewform?usp=sf_link
              </a>
            </div>
          </div>
      ...
      <div className="footer flex items-center justify-between bg-[#FFA701]  h-[35vh] w-[100vw]">
        <div className="footer_name pl-[35rem] leading-[4rem]  ">
          <h1 className="text-[48px] text-slate-50 font-[600] normal font-['Open_Sans']">
            Have some more questions?
          </h1>
          <button className="ml-[13rem] mt-[2rem]  px-[25px] rounded-[12px] text-[36px] bg-[white] font-['Raleway'] font-[700] text-[#469697] ">
            Contact us
          </button>
        </div>
