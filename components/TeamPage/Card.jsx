        ...
        <div className={classes.social_container}>
          <ul className={classes.social_links}>
            <li className={classes.link_container}>
              <a href={m.linkedin} className={classes.link} target="_blank">
                <Image alt="xyz" src={linkedin} width={40} height={40} />
              </a>
            </li>
            <li className={classes.link_container}>
              <a href={m.instagram} className={classes.link} target="_blank">
                <Image alt="xyz" src={instagram} width={40} height={40} />
              </a>
            </li>
            <li className={classes.link_container}>
              <a href={m.github} className={classes.link} target="_blank">
