...
const LandingSlide = () => {
  ...
  return (
    ...
    <div className="flex flex-col justify center items-center bg-[#091E32] rounded-b-[16%]">
      <div>
      ...
      <h1 className="text-[#89BAEE] text-center pt-4">DYPCOE, <span className="text-white text-center"> Pune.</span> </h1>
      </div>
      ...
      <Link href="/events" >
        ...
        <a href="#timeline">
          <div href className='transition delay-150  hover:-translate-x-1 hover:scale-50 duration-300 flex relative lg:top-[60px] top-[20px] justify-center items-center'>
